export const Config = {
  ...
  FIREBASE_SERVICE_ACCOUNT_SECRET_ARN: process.env.FIREBASE_SERVICE_ACCOUNT_SECRET_ARN as string,
...
if (!Config.FIREBASE_SERVICE_ACCOUNT_SECRET_ARN) throw new Error("Warning: Please set FIREBASE_SERVICE_ACCOUNT_SECRET_ARN.");